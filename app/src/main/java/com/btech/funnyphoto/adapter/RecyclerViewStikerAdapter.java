...
public class RecyclerViewStikerAdapter extends RecyclerView.Adapter<RecyclerViewStikerAdapter.ViewHolder> implements View.OnClickListener {

    private List<TemplateListModel> items;
    private OnItemClickListener onItemClickListener;
    private Context mContext;

    public RecyclerViewStikerAdapter(Context context, List<TemplateListModel> items) {
        this.items = items;
    ...
    public void onClick(final View v) {
        ...
        if (onItemClickListener != null) {
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    onItemClickListener.onItemStikerClick(v, (TemplateListModel) v.getTag());
                }
            }, 200);
        }
    }
    ...
    public interface OnItemClickListener {
        ...
        void onItemStikerClick(View view, TemplateListModel viewModel);
